...
namespace MakeFileCopyWithReplacedString
{
    class Program
    {
        static void Main(string[] args)
        {
            if (args.Length != 4 || string.IsNullOrEmpty(args[0]) || string.IsNullOrEmpty(args[0]) || string.IsNullOrEmpty(args[2]) || string.IsNullOrEmpty(args[3]))
            {
                Console.WriteLine("Syntax: MakeFileCopyWithReplacedString [full file path] [old string] [new string]");
